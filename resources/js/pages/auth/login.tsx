            ...
            >
                {({ processing, errors }) => (
                    <>
                        ...
                        <a
                            href="/auth/google"
                            className="flex items-center justify-center gap-3 w-full h-11 px-4 rounded-md border border-input bg-background hover:bg-accent hover:text-accent-foreground transition-colors"
                        >
